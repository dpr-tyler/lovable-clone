...
export const codeAgentFunction = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    const fragementTitleGenerator = createAgent({
      ...
      description: "A fragement title generator agent",
    ...
    const { output: fragementTitleOutput } = await fragementTitleGenerator.run(
        ...
        data: {
          ...
          fragment: {
            create: {
              ...
              title: parseAgentOutput(fragementTitleOutput),
